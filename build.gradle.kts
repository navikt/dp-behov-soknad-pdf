...
dependencies {
    ...
    implementation("io.github.openhtmltopdf:openhtmltopdf-pdfbox:1.1.60")
    implementation("io.github.openhtmltopdf:openhtmltopdf-slf4j:1.1.60")
    implementation("io.github.openhtmltopdf:openhtmltopdf-svg-support:1.1.60")
